...
namespace Omicron
{
    public static class GraphicsManager
    {
        ...
        public static void DrawSprite(Sprite sprite, Vector2 offset)
        {
            ...
            spriteBatch.Draw(sprite.Texture, sprite.Position - offset, sprite.SourceRectangle, sprite.Color, sprite.Rotation, sprite.Origin, sprite.Scale, sprite.SpriteEffects, 0);
        }
